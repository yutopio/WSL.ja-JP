...
WSL (Ubuntu 18.04) に SQL Server をインストールするには、次のクイックスタートに従ってください。 [ubuntu で SQL Server をインストールし、データベースを作成](https://docs.microsoft.com/sql/linux/quickstart-install-connect-ubuntu?view=sql-server-ver15)します。
